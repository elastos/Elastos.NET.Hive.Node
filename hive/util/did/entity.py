...
class Entity:
    ...
    def get_auth_token_by_sign_in(self, base_url, vc_str, subject):
        ...
        rt, status_code, err = self.post(base_url + '/api/v2/did/signin', {"id": doc})
    ...
    def get_backup_auth_from_node(self, base_url, auth_token, hive_did):
        rt, status_code, err = self.post(base_url + '/api/v2/did/backup_auth', {"challenge_response": auth_token})
        if err != None:
